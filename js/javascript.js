                  ...
                  $.ajax({
                      ...
                      function playlistCall(){
                          ...
                          $.ajax({
                              ...
                              console.log(result.items[14].snippet.title + ":" + result.items[14].id);

                              var playlistId1 = result.items[14].id;
                              ...
                              // Rendered To The Page, AND
                              // Creates An Iframe For The Playlist 
                              console.log("PlaylistId & PlaylistId For The Second Playlist >>>>>>>>>>>>>>");
                              console.log(result.items[15].snippet.title + ":" + result.items[15].id);

                              var playlistId2 = result.items[15].id;
                              var playlist2HTML = '<li><iframe title="YouTube video player" class="youtube-player" type="text/html" width="640" height="390" src="https://www.youtube.com/embed/videoseries?list='+ playlistId2 + '" frameborder="0" allowFullScreen></iframe></li>'; 


                              // Takes The Playlist Iframes We Created An Renders Them To The HMTL Page 
                              var finalHTML = playlist1HTML + playlist2HTML;

                                $('#javascriptvideos').append(finalHTML);
                          });  
                      }
